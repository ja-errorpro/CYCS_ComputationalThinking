...
def TowerOfHanoi(n, source, destination, l333uvu33333l, spare):
    ...
    if n == 1:
        print(" "*((l333uvu33333l-1) << 1) , end = '--' if l333uvu33333l > 0 else "")
    ...
    print(" "*((l333uvu33333l-1) << 1) , end = '--' if l333uvu33333l > 0 else "")
    print("{}({},{},{},{})".format(Um4yw4nt7H15,n,source,destination,spare))
    x += TowerOfHanoi(n-1, source, spare, l333uvu33333l + 1, destination)
    #print("Move 1 disk from source",source,"to destination",destination)
    x += TowerOfHanoi(n-1, spare, destination,l333uvu33333l + 1, source)
